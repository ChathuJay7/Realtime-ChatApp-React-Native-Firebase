...
const ProfileScreen = () => {
  ...
  return (
    <SafeAreaView
      ...
      className="flex-1 items-ceter justify-start"
    >
      {/* Icons */}
      ...
      <View className="w-full px-6 py-4 flex-row items-center justify-between">
        <View className="flex-row items-center">
            ...
            <Text className="text-base font-semibold text-primaryText px-3">Media & Downloads</Text>
        </View>
        <MaterialIcons name="chevron-right" size={32} color={"#555"}/>
      </View>
      <View className="w-full px-6 py-4 flex-row items-center justify-between">
        <View className="flex-row items-center">
            ...
            <Text className="text-base font-semibold text-primaryText px-3">Accounts</Text>
        </View>
        <MaterialIcons name="chevron-right" size={32} color={"#555"}/>
      </View>
